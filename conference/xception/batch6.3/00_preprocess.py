...
if __name__ == "__main__":
    cells_dir = "/home/ssd0/Develop/liyu/xcp-batch6.3/CELLS-new"
    
    # process original images
    cells_dir_half = "/home/ssd0/Develop/suyongjian/batch6.3-cells/CELLS-half"
    
    process_half_image(cells_dir, cells_dir_half, depth=1, size=224, hls=False)
    ...
    cells_dir_half_hls05 = "/home/ssd0/Develop/suyongjian/batch6.3-cells/CELLS-half-hls05"
    
    HLS_L = [0.5]
    HLS_S = [0.4, 0.5]
    
    process_half_image(cells_dir, cells_dir_half_hls05, depth=1, size=224, hls=True)
    ...
    cells_dir_half_hls07 = "/home/ssd0/Develop/suyongjian/batch6.3-cells/CELLS-half-hls07"
    
    HLS_L = [0.7]
    HLS_S = [0.4, 0.5]
    
    process_half_image(cells_dir, cells_dir_half_hls07, depth=1, size=224, hls=True)
