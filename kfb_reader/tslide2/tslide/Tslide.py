...
def main():
    slide = KfbSlide("/home/sakulaki/yolo-yuli/one_stop_test/yantian_kfb/kfb/2018-07-29-04_03_58.kfb")
    ...
    #     file.write(imb)
    # print(img.shape)
    # im.save("/home/sakulaki/yolo-yuli/one_stop_test/yantian_kfb/2018-07-29-04_03_58_top.jpg")
    im.close()
