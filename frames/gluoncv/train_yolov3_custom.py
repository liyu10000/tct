...
class CustomDetection(VisionDataset):
    ...
    """
    CLASSES = ('ASCUS', 'LSIL', 'HSIL', 'SCC', \
        'AGC', 'EC', 'FUNGI', 'TRI', 'CC', 'ACTINO', 'VIRUS')

    def __init__(self, root=os.path.join('datasets', 'voc'),
        ...
        self._anno_path = os.path.join('/home/hdd_array0/batch6_1216/annotations', '{}.xml')
        self._image_path = os.path.join('/home/hdd_array0/batch6_1216/train', '{}.bmp')
    ...
    def _load_items(self, splits):
        ...
        for year, name in splits:
            ...
            lf = os.path.join('./', name + '.txt')
            print("lf: ", lf)
            with open(lf, 'r') as f:
                ids += [("/home/hdd_array0/batch6_1216/annotations", line.strip()) for line in f.readlines()]
                print("ids", ids)
        return ids
...
if __name__ == '__main__':
    ...
    train_data, val_data = get_dataloader(async_net, train_dataset, val_dataset, args.data_shape, args.batch_size, args.num_workers, args)
