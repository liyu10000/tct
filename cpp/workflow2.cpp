...
void yolo_predictor(char *cfgfile, char *weightfile, char *metafile, int gpu) {
    // specify which gpu to use. It is problematic, multithreading cannot seem to access parent queue
    // cuda_set_device(gpu);
