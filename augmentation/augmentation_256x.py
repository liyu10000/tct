...
class Img:
    ...
    def augment(self, w, h):
        ...
        new_w = self.w * 0.8
        new_h = self.h * 0.8
        self.crop(int(uniform(new_w / 2, self.w - new_w / 2)), int(uniform(new_h / 2, self.h - new_h / 2)), new_w,
                  new_h)  # 随机切割
        self.crop(int(uniform(new_w / 2, self.w - new_w / 2)), int(uniform(new_h / 2, self.h - new_h / 2)), new_w,
                  new_h)  # 随机切割
        self.crop(int(uniform(new_w / 2, self.w - new_w / 2)), int(uniform(new_h / 2, self.h - new_h / 2)), new_w,
...
if __name__ == '__main__':
    ...
    file_path_in = "/home/ubuntu/Ma/data/tct0514/train/"
    file_path_out = "/home/ubuntu/Ma/data/tct0514/train-aug/"
